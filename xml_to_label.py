...
for Dir in listOfDirs:
    ...
    listOfBinFiles = [f for f in os.listdir('./pc/'+"pc-"+Dir+"-proc") ]
    listOfBinFiles.sort()
	...
	wsp = float(len(listOfBinFiles))/float(len(itemlistX))
	    ...
	    Text = ObjType+" "+truncation+" "+ occlusion+" 0 "+"0 "+"0 "+"0 "+"0 "+h+" "+w+" "+l+" "+x+" "+y+" "+z+" 0" + "\n"
	    with open(LabDir+"/"+listOfBinFiles[j][:-4]+".txt", "a") as myfile:
    	        myfile.write(Text)
